...
export async function fetchHospitalIndex(): Promise<
  { code: string; name: string; areaCode: string; areaName: string; prefecture: string; totalBeds: number; bedsByFunction: Record<string, number>; recoveryRelatedBeds: number }[]
> {
